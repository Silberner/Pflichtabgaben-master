public class  CLkw implements IFahrzeug{
    ...
    public CLkw()
    {
      ...
      this( "rot", "MAN", 8, 120, 540, 120 );
    }
  
 
    public CLkw( final String p_farbe, final String p_marke, final int p_anzahlGaenge, final int p_maxGeschwindigkeit, final int p_kw, final int p_ladung)
    {
      m_farbe = p_farbe;
      m_marke = p_marke;
